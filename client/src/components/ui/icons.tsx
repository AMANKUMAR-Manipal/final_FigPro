...
export const UserAvatars = () => (
  <div className="flex -space-x-2">
    <svg className="h-8 w-8 rounded-full ring-2 ring-white" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="50" cy="50" r="50" fill="#f5f5f5" />
      <circle cx="50" cy="40" r="20" fill="#d1d5db" />
      <path d="M25,85 C25,65 75,65 75,85" fill="#d1d5db" />
    </svg>
    <svg className="h-8 w-8 rounded-full ring-2 ring-white" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg className="h-8 w-8 rounded-full ring-2 ring-white" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M25,85 C25,65 75,65 75,85" fill="#6b7280" />
    </svg>
  </div>
);
